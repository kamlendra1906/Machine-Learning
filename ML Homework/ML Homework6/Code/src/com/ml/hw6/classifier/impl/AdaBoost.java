...
import com.ml.hw6.model.AdaBoostModel;
import com.ml.hw6.model.DecisionStumpModel;
import com.ml.hw6.model.Model;
import com.ml.hw6.stats.ActiveLearningDataStats;
...
public class AdaBoost implements Classifier {
	...
	public void trainModel(DataSet trainingDataSet, DataSet testDataSet,  Map<String, Object> additionalData) throws Exception {
		...
		while(adaBoostModel.getClassifiers().size() < this.maxBoostingRound) {
			...
			System.out.println(round+"   "+this.testModel(trainingDataSet, additionalData)+"    "+ this.testModel(testDataSet, additionalData));
			round++;
		}
	}
	...
	private Map<Integer, Set<Double>> getFeatureIdValuesMap(DataSet trainingDataSet) throws Exception {
		...
		List<Feature> features = trainingDataSet.getFeatures();
